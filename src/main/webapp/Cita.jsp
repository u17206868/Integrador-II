...
<t:template title="Listar Inventario">
                        ...
                        <div class="form-group form-group-default">
                          ...
                          <select class="form-control" name="addServicioId">
                            <c:forEach var="tempC" items="${servicios}">
                              <option value="${tempC.id}">S/${tempC.precio}: ${tempC.minutos}min: ${tempC.descripcion}: </option>
                            </c:forEach>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="modal" id="${tempObjeto.id}${tempObjeto.uniqueId}${tempObjeto.id}" role="dialog">
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title">
                              <span class="fw-mediumbold">Detalles del</span>
                              <span class="fw-light">Producto</span>
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
      ...
      function miFuncionEliminar(id) {
        ...
        swal({
          ...
          if (Delete) {
            ...
            swal({
              title: 'Eliminado!',
              text: 'Su cita ha sido eliminada.',
              type: 'success',
              buttons: {
                confirm: {
