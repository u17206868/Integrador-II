...
@WebServlet(name = "ProduccionCreateServlet", urlPatterns = {"/ProduccionCreateServlet"})
public class ProduccionCreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        produccion.setUniqueId(UUID.randomUUID().toString());

        jpacProduccion.create(produccion);
