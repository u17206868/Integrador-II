 ...
 * @author HP
 */
@WebServlet(name = "ProducListServlet", urlPatterns = {"/ProducListServlet"})
public class ProducListServlet extends HttpServlet {
    ...
    System.out.println("Entrando al Lista de producciones Servlet");
