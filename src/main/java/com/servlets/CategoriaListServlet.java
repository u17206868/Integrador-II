...
@WebServlet(name = "CategoriaListServlet", urlPatterns = {"/CategoriaListServlet"})
public class CategoriaListServlet extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    System.out.println("Entrando a Categoria List Servlet");
    try {
...
//      }
      categorias.forEach(c -> System.out.println(c.getId() + ": " + c.getDescripcion()));
