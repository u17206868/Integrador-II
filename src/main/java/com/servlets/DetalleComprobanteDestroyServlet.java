...
public class DetalleComprobanteDestroyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DetalleComprobanteJpaController jpaObject = new DetalleComprobanteJpaController(emf);
            DetalleComprobante objetoArchivado;

            objetoArchivado = jpaObject.findDetalleComprobante(Long.valueOf(request.getParameter("destroyId")));
