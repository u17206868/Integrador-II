...
public class PersonaJpaController implements Serializable {
    ...
    public List<Persona> findPersonaPorTipo(int idTipoPersona) {
        EntityManager em = getEntityManager();
        List<Persona> personas = em.createQuery(
                "SELECT p FROM Persona p JOIN FETCH p.tipoPersonaId tp WHERE tp.id = :tipoPersonaId",
                Persona.class)
                .setParameter("tipoPersonaId", idTipoPersona)
                .getResultList();
        return personas;
    }
    ...
    public void create(Persona persona) {
        ...
        if (persona.getProduccionList() == null) {
            persona.setProduccionList(new ArrayList<Produccion>());
        }
        ...
        try {
            ...
            for (Produccion produccionListProduccionToAttach : persona.getProduccionList()) {
            ...
            persona.setProduccionList(attachedProduccionList);
            em.persist(persona);
            if (distritoId != null) {
            ...
            for (Produccion produccionListProduccion : persona.getProduccionList()) {
                Persona oldTecnicoIdOfProduccionListProduccion = produccionListProduccion.getTecnicoId();
                produccionListProduccion.setTecnicoId(persona);
                produccionListProduccion = em.merge(produccionListProduccion);
                if (oldTecnicoIdOfProduccionListProduccion != null) {
                    oldTecnicoIdOfProduccionListProduccion.getProduccionList().remove(produccionListProduccion);
                    oldTecnicoIdOfProduccionListProduccion = em.merge(oldTecnicoIdOfProduccionListProduccion);
                }
            }
    ...
    public void edit(Persona persona) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<Produccion> produccionListOld = persistentPersona.getProduccionList();
            List<Produccion> produccionListNew = persona.getProduccionList();
            ...
            persona.setProduccionList(produccionListNew);
            ...
            for (Produccion produccionListOldProduccion : produccionListOld) {
                if (!produccionListNew.contains(produccionListOldProduccion)) {
                    produccionListOldProduccion.setTecnicoId(null);
            ...
            for (Produccion produccionListNewProduccion : produccionListNew) {
                if (!produccionListOld.contains(produccionListNewProduccion)) {
                    Persona oldTecnicoIdOfProduccionListNewProduccion = produccionListNewProduccion.getTecnicoId();
                    produccionListNewProduccion.setTecnicoId(persona);
                    produccionListNewProduccion = em.merge(produccionListNewProduccion);
                    if (oldTecnicoIdOfProduccionListNewProduccion != null && !oldTecnicoIdOfProduccionListNewProduccion.equals(persona)) {
                        oldTecnicoIdOfProduccionListNewProduccion.getProduccionList().remove(produccionListNewProduccion);
                        oldTecnicoIdOfProduccionListNewProduccion = em.merge(oldTecnicoIdOfProduccionListNewProduccion);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Long id) throws NonexistentEntityException {
        ...
        try {
            ...
            List<Produccion> produccionList = persona.getProduccionList();
            for (Produccion produccionListProduccion : produccionList) {
                produccionListProduccion.setTecnicoId(null);
                produccionListProduccion = em.merge(produccionListProduccion);
            }
            em.remove(persona);
            em.getTransaction().commit();
