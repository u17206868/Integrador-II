...
@WebServlet(name = "ServicioXTipoServlet", urlPatterns = {"/ServicioXTipoServlet"})
public class ServicioXTipoServlet extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        
        System.out.println("------------------------------ServicioXTipoServlet------------------------------");
        ...
        try {
            ...
            File jasperFile = new File(context.getRealPath("reportes/Leaf_Grey2.jasper"));
...
//      byte[] bytess = JasperRunManager.runReportToPdf("D:\\report1.jasper", parametro, con);
            byte[] bytess = JasperRunManager.runReportToPdf(jasperFile.getPath(), parametro, conexion);
