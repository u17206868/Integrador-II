...
@WebServlet(name = "ReporteDistritosServlet", urlPatterns = {"/ReporteDistritosServlet"})
public class ReporteDistritosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File jasperFile = new File(context.getRealPath("reportes/Distritos.jasper"));
